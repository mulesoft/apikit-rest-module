 ...
 * <p/>
 * <p>
 * All tokens can be represented as a text expression which cannot be <code>null</code>.
 * <p/>
 * <p>
...
public interface Token {
   ...
   * <p/>
   * <p>
   * The resolution process requires all variables referenced in the token to be mapped to the value that is present in the
   * expanded URI data.
   *
